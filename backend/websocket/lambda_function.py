...
apigw = boto3.client('apigatewaymanagementapi',endpoint_url=os.environ.get("ENDPOINT_URL"))
    ...
    if route_key:
        if  route_key == "$connect":
            ...
            if input_bid_num and input_bid_num:
                responce = bid_event_publish(item_id=input_item_id,bid_num=input_bid_num)
                return responce
            else :
                return {
                'statusCode': 500,
